...
if __name__ == "__main__":    
    ...
    # Select sublabel for dataset, set to "all" for no filtering
    # "fraud", "hate", "smuggle", "self", "jailbreak", "sexual", "violent", "cyber"
    label = "hate"
    ...
    if compute_neuron_activation or perform_safety_prob:
        print(f"=====Tested Dataset Label: {label}=====")
        questions, labels = util.load_sorted_datasets(False, label)
