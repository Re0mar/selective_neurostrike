...
if __name__ == "__main__":        
    ...
    categories = ["fraud", "hate", "smuggle", "self", "jailbreak", "sexual", "violent", "cyber"]

    for category in categories:
        subset = util.load_sorted_datasets(False, category, True)
        ...
        # We allow reasoning model to think
        ...
        for responses in all_responses:
            ...
            for i, judge_prompt in enumerate(judge_prompts):
                # print(f"Moderating {i + 1}/{len(judge_prompts)}")
            ...
            print(f"Success rate for {category}: {jailbreaking_counter}/{len(questions)}")
